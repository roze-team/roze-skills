...
- [references/governance-operations.md](references/governance-operations.md): use for config, strict ServiceConfig validation, database direct/proxy/sharded modes, registry, gateway, Redis standalone/Cluster topology, distributed rate limiting, MQ, DTM, persistent outbox, cache consistency, object storage, Qiniu Kodo/S3-compatible storage, read-model composition, lifecycle, metrics, tracing, release gates, production evidence, smoke/soak scripts, and hot-path expectations.
